...
public : 
    PetakMulai(int indeks, const std::string& kode, const std::string& nama);
...
public : 
    PetakPenjara(int indeks, const std::string& kode, const std::string& nama);
    void onLanded (Pemain &p, PlayerActionService& actionService) override;
...
public : 
    PetakPergiPenjara(int indeks, const std::string& kode, const std::string& nama);
    void onLanded (Pemain &p, PlayerActionService& actionService) override;
...
public : 
    PetakBebasParkir(int indeks, const std::string& kode, const std::string& nama);
    void onLanded (Pemain &p, PlayerActionService& actionService) override;
